...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<ArticleEntity>[] is M) {
      return data.map<ArticleEntity>((Map<String, dynamic> e) =>
          ArticleEntity.fromJson(e)).toList() as M;
    }
    if (<Article>[] is M) {
      return data.map<Article>((Map<String, dynamic> e) =>
          Article.fromJson(e)).toList() as M;
    }
    if (<Source>[] is M) {
      return data.map<Source>((Map<String, dynamic> e) =>
          Source.fromJson(e)).toList() as M;
    }
